...
local blessKeyword = keywordHandler:addKeyword({'blood of the mountain'}, StdModule.say, {npcHandler = npcHandler,
	text = {
	...
	blessKeyword:addChildKeyword({'yes'}, StdModule.bless, {npcHandler = npcHandler, text = 'So receive the protection of the blood of the mountain, pilgrim.', cost = '|PVPBLESSCOST|', bless = 8})
